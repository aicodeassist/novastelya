...
const MATERIALS = [
  {
    id: "matte",
    price: 220,
    uk: { title: "Матове", meta: "MSD Premium • 220 ₴/м²", tooltip: "Класична матова фактура без відблисків. Ідеально рівна поверхня, що виглядає як якісна штукатурка." },
    ru: { title: "Матовое", meta: "MSD Premium • 220 ₴/м²", tooltip: "Классическая матовая фактура без бликов. Идеально ровная поверхность, выглядящая как качественная штукатурка." }
  },
  {
    id: "satin",
    price: 230,
    uk: { title: "Сатин", meta: "MSD Premium • 230 ₴/м²", tooltip: "Ніжна перламутрова фактура з легким світловідбиванням. Створює м'який затишний ефект в кімнаті." },
    ru: { title: "Сатин", meta: "MSD Premium • 230 ₴/м²", tooltip: "Нежная перламутровая фактура с легким светоотражением. Создает мягкий уютный эффект в комнате." }
  },
  {
    id: "glossy",
    price: 220,
    uk: { title: "Глянцеве", meta: "MSD Premium • 220 ₴/м²", tooltip: "Дзеркальна фактура, яка візуально збільшує простір та висоту стелі. Рекомендується для невеликих кімнат." },
    ru: { title: "Глянцевое", meta: "MSD Premium • 220 ₴/м²", tooltip: "Зеркальная фактура, визуально увеличивающая пространство и высоту потолка. Рекомендуется для небольших комнат." }
  },
  {
    id: "fabric",
    price: 650,
    uk: { title: "Тканинне", meta: "Descor • 650 ₴/м²", tooltip: "Преміальне безшовне дихаюче полотно на тканинній основі. Екологічно чисте, міцне, встановлюється без нагріву." },
    ru: { title: "Тканевое", meta: "Descor • 650 ₴/м²", tooltip: "Премиальное бесшовное дышащее полотно на тканевой основе. Экологически чистое, прочное, устанавливается без нагрева." }
  },
  {
    id: "acoustic",
    price: 1200,
    uk: { title: "Акустичне", meta: "Clipso • 1200 ₴/м²", tooltip: "Полотно з мікроперфорацією, що поглинає шум та відлуння. Покращує акустичний комфорт у спальнях та домашніх кінотеатрах." },
    ru: { title: "Акустическое", meta: "Clipso • 1200 ₴/м²", tooltip: "Полотно с микроперфорацией, поглощающее шум и эхо. Улучшает акустический комфорт в спальнях и домашних кинотеатрах." }
  },
  {
    id: "translucent",
    price: 750,
    uk: { title: "Напівпрозоре", meta: "Для підсвічування • 750 ₴/м²", tooltip: "Пропускає до 50% світла. Використовується для створення повністю світлових стель або ефекту зоряного неба." },
    ru: { title: "Полупрозрачное", meta: "Для подсветки • 750 ₴/м²", tooltip: "Пропускает до 50% света. Используется для создания полностью световых потолков или эффекта звездного неба." }
  }
];
...
const TECHNOLOGY = [
  ...
  },
  {
    id: "shadow",
    price: 350,
    uk: { title: "Тіньовий", meta: "Eurokraab • +350 ₴/м.п", tooltip: "Преміальний профіль Eurokraab, що створює ефект стелі, яка левітує, з рівним тіньовим швом 6 мм замість гумового плінтуса." },
    ru: { title: "Теневой", meta: "Eurokraab • +350 ₴/м.п", tooltip: "Премиальный профиль Eurokraab, создающий эффект левитирующего потолка с ровным теневым швом 6 мм вместо резинового плинтуса." }
  },
  {
    id: "floating",
    price: 450,
    uk: { title: "Парящий", meta: "LED по периметру • +450 ₴/м.п", tooltip: "Профіль з нішею для світлодіодної стрічки. М'яке світло спрямоване вздовж стіни, створює візуальний ефект ширяння стелі." },
    ru: { title: "Парящий", meta: "LED по периметру • +450 ₴/м.п", tooltip: "Профиль с нишей для светодиодной ленты. Мягкий свет направлен вдоль стены, создает визуальный эффект парения потолка." }
  },
  {
    id: "slotted",
    price: 500,
    uk: { title: "Щілинний", meta: "Nivel 15 • +500 ₴/м.п", tooltip: "Безщілинна система Nivel. Полотно ідеально прилягає до стіни без жодних проміжків, гумових вставок чи видимих стиків." },
    ru: { title: "Нишевый", meta: "Nivel 15 • +500 ₴/м.п", tooltip: "Бесщелевая система Nivel. Полотно идеально прилегает к стене без каких-либо зазоров, резиновых вставок или видимых стыков." }
  },
  {
    id: "double",
    price: 1500,
    uk: { title: "Дворівневий", meta: "Перепад висот • +1500 ₴/м.п", tooltip: "Створення геометричних багаторівневих конструкцій з алюмінієвого профілю з рівним перепадом висот та підсвічуванням." },
    ru: { title: "Двухуровневый", meta: "Перепад высот • +1500 ₴/м.п", tooltip: "Создание геометрических многоуровневых конструкций из алюминиевого профиля с ровным перепадом высот и подсветкой." }
  },
  {
    id: "carved",
    price: 1200,
...
const COLOR = [
  ...
  },
  {
    id: "black",
    price: 120,
    uk: { title: "Чорний глянець", meta: "Дзеркальний ефект · +120 ₴/м²", tooltip: "Створює приголомшве глибоке відображення. Візуально подвоює высоту кімнати, виглядає суперсучасно." },
  ...
  },
  {
    id: "print",
    price: 650,
    uk: { title: "Фотодрук", meta: "Екосольвент · +650 ₴/м²", tooltip: "Художній друк на полотні екологічно чистими фарбами. Небо з хмарами, абстракції або будь-які малюнки." },
    ru: { title: "Фотопечать", meta: "Экосольвент · +650 ₴/м²", tooltip: "Художественная печать на полотне экологически чистыми красками. Небо с облаками, абстракции или любые рисунки." }
  },
  {
    id: "texture",
    price: 350,
...
const LIGHTS = [
  {
    ...
    price: 300,
    max: 10,
    uk: { title: "Люстра (гакова / стельова)", desc: "Монтаж платформи та закладної • 300 ₴/шт", unit: "шт" },
    ru: { title: "Люстра (крючковая / потолочная)", desc: "Монтаж платформы и закладной • 300 ₴/шт", unit: "шт" }
  },
  {
    id: "spot",
    price: 300,
    max: 40,
    uk: { title: "Точкові світильники", desc: "Врізні LED, платформа • 300 ₴/шт", unit: "шт" },
    ru: { title: "Точечные светильники", desc: "Врезные LED, платформа • 300 ₴/шт", unit: "шт" }
  },
  {
    id: "track",
    price: 400,
    max: 20,
    uk: { title: "Трекові системи (магнітні)", desc: "Вбудовані в полотно • 400 ₴/м.п", unit: "м.п" },
    ru: { title: "Трековые системы (магнитные)", desc: "Встроенные в полотно • 400 ₴/м.п", unit: "м.п" }
  },
  {
    id: "line",
    price: 650,
    max: 30,
    uk: { title: "Світлові лінії", desc: "LED-стрічка в профілі • 650 ₴/м.п", unit: "м.п" },
    ru: { title: "Световые линии", desc: "LED-лента в профиле • 650 ₴/м.п", unit: "м.п" }
  },
  {
    id: "backlight",
    price: 450,
    max: 30,
    uk: { title: "Контурне підсвічування", desc: "LED за полотном • 450 ₴/м.п", unit: "м.п" },
    ru: { title: "Контурная подсветка", desc: "LED за полотном • 450 ₴/м.п", unit: "м.п" }
  },
  {
    id: "starry",
    price: 2500,
...
const EXTRA_SERVICES_QTY = [
  {
    ...
    price: 200,
    max: 6,
    uk: { title: "Обхід труби", desc: "200 ₴/шт" },
    ru: { title: "Обход трубы", desc: "200 ₴/шт" }
  },
  {
    id: "vent",
    price: 300,
    max: 6,
    uk: { title: "Вентиляційна решітка", desc: "Врізка в полотно • 300 ₴/шт" },
    ru: { title: "Вентиляционная решетка", desc: "Врезка в полотно • 300 ₴/шт" }
  },
  {
    id: "curtain",
    price: 550,
    max: 10,
    uk: { title: "Прихований карніз", desc: "Ніша під штори • 550 ₴/м.п" },
    ru: { title: "Скрытый карниз", desc: "Ниша под шторы • 550 ₴/м.п" }
  }
];
...
const EXTRA_SERVICES_BOOL = [
  {
    id: "dismantle",
    price: 150,
    uk: { title: "Демонтаж старої стелі", desc: "150 ₴/м²" },
    ru: { title: "Демонтаж старого потолка", desc: "150 ₴/м²" }
  },
  {
    id: "wiring",
    price: 1500,
    uk: { title: "Електророзводка", desc: "Монтаж проводки та дротів • 1500 ₴" },
    ru: { title: "Электроразводка", desc: "Монтаж проводки и проводов • 1500 ₴" }
  },
  {
    id: "design",
    price: 2000,
    uk: { title: "3D-візуалізація проєкту", desc: "Індивідуальний дизайн • 2000 ₴" },
    ru: { title: "3D-визуализация проекта", desc: "Индивидуальный дизайн • 2000 ₴" }
  }
];
